    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>
          Inicia sesion para crear listas y administrar regalos
        </Text>
        ...
        <TouchableOpacity
          ...
          disabled={isLoading}
        >
          {isLoading ? <ActivityIndicator color="#fff" /> : <Text style={styles.btnPrimaryText}>Entrar</Text>}
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.btnGoogle} onPress={loginWithGoogle} disabled={isLoading}>
          <Text style={styles.btnGoogleIcon}>G</Text>
          <Text style={styles.btnGoogleText}>Continuar con Google</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.btnGitHub} onPress={loginWithGitHub} disabled={isLoading}>
          <Text style={styles.btnGitHubText}>Continuar con GitHub</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.btnApple} disabled={isLoading}>
...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: '#D3D1C7', borderRadius: 10, padding: 14, fontSize: 15, color: '#2C2C2A', backgroundColor: '#FAFAF8', marginBottom: 14 },
  errorBox: { backgroundColor: '#FFE5E5', borderRadius: 8, padding: 10, marginBottom: 10 },
  ...
  btnGoogle: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: '#D3D1C7', borderRadius: 10, padding: 14, marginBottom: 10, backgroundColor: '#fff' },
  btnGoogleIcon: { fontSize: 16, fontWeight: '700', color: '#EA4335', marginRight: 8 },
  btnGoogleText: { fontSize: 15, fontWeight: '600', color: '#2C2C2A' },
  btnGitHub: { borderWidth: 1.5, borderColor: '#24292e', borderRadius: 10, padding: 14, alignItems: 'center', marginBottom: 10, backgroundColor: '#24292e' },
  btnGitHubText: { fontSize: 15, fontWeight: '600', color: '#fff' },
  btnApple: { borderWidth: 1.5, borderColor: '#000', borderRadius: 10, padding: 14, alignItems: 'center', marginBottom: 10, backgroundColor: '#000' },
